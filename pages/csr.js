            ...
            <div className='title_holder singleVerticalBreadcrumb'>
              ...
              <div className='industify_fn_breadcrumbs'>
                <ul>
                  ...
                  <li>
                    <span className='bread-current'>CSR</span>
                  </li>
                </ul>
              </div>
            </div>
              ...
              <div className='inner'>
                <div className='left_part'>
                  <div className='title_holder'>
                    <h3 className='l_title'>Corporate Social Responsibility</h3>
                    <p className='l_desc'>
                      ...
                      environment. BMTF has established a high school inside its
                      premises to help improve educational status of the
                      children of the employees. For children of low scale
                      workers, BMTF CSR department exempt their tuition fees.
                      Apart from all these BMTF patronize different initiatives
                      for overall wellbeing of its employees. It has an enormous
                      picnic spot for recreation of the employees and their
                      family members.
                    </p>
                    <p>
                      Besides, we believe in religious and cultural harmony. A
                      beautiful mosque is there inside the vast area. During
                      Covid-19 pandemic BMTF has played a very pivotal role. It
                      has maintained salaries and wages of its employees’ and
                      workers on a regular basis. During the early phase, BMTF
                      handed down ventilators to Combined Military Hospital-CMH
                      to meet the growing demand. Also it has aided Kuwait Armed
                      Forces with Health Sanitizing Products.
                    </p>
                  </div>
                </div>
