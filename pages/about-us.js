        ...
        <div className='industify_fn_sidebarpage'>
          ...
          <div className='container'>
            <div className='ourHistory'>
              <div class='timeline'>
                <h2 className=''>Our History</h2>
                <div class='timeline__event  animated fadeInUp delay-3s timeline__event--type1'>
                  <div class='timeline__event__icon '>
                    {/* <i class='lni-cake'></i> */}
                    <Arrow_r className='fn__svg' />
                    <div class='timeline__event__date'>In 1963</div>
                  </div>
                ...
                <div class='timeline__event animated fadeInUp delay-2s timeline__event--type2'>
                  <div class='timeline__event__icon'>
                    ...
                    <Arrow_r className='fn__svg' />
                    <div class='timeline__event__date'>In 1967</div>
                  </div>
                  <div class='timeline__event__content'>
                    <div class='timeline__event__description'>
                      <p>
                ...
                <div class='timeline__event animated fadeInUp delay-1s timeline__event--type3'>
                  <div class='timeline__event__icon'>
                    {/* <i class='lni-slim'></i> */}
                    <Arrow_r className='fn__svg' />
                    <div class='timeline__event__date'>In 1972</div>
                  </div>
                  <div class='timeline__event__content'>
                    <div class='timeline__event__description'>
                      <p>
                ...
                <div class='timeline__event animated fadeInUp timeline__event--type4'>
                  <div class='timeline__event__icon'>
                    {/* <i class='lni-cake'></i> */}
                    <Arrow_r className='fn__svg' />
                    <div class='timeline__event__date'>In 1979</div>
                  </div>
                  <div class='timeline__event__content'>
                    <div class='timeline__event__description'>
                      <p>
                ...
                <div class='timeline__event animated fadeInUp timeline__event--type1'>
                  <div class='timeline__event__icon'>
                    {/* <i class='lni-cake'></i> */}
                    <Arrow_r className='fn__svg' />
                    <div class='timeline__event__date'>In 2000</div>
                  </div>
                  <div class='timeline__event__content'>
                    <div class='timeline__event__description'>
                      <p>
                ...
                <div class='timeline__event animated fadeInUp timeline__event--type5'>
                  <div class='timeline__event__icon'>
                    {/* <i class='lni-cake'></i> */}
                    <Arrow_r className='fn__svg' />
                    <div class='timeline__event__date'>From 1994-2000</div>
                  </div>
                  <div class='timeline__event__content'>
                    <div class='timeline__event__description'>
